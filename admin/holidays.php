...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button type="button" class="btn btn-primary shadow-sm" data-bs-toggle="modal" data-bs-target="#holidayModal">
        <i class="bi bi-plus-lg"></i> <?php echo __('add_holiday'); ?>
    </button>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title fw-bold"><i class="bi bi-calendar"></i> <?php echo __('add_holiday'); ?></h5>
            ...
            <form action="holidays.php" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label small fw-bold"><?php echo __('name_ar'); ?> *</label>
                        <input type="text" name="name_ar" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label small fw-bold"><?php echo __('name_en'); ?> *</label>
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="submit" name="add_holiday" class="btn btn-primary px-4 shadow-sm"><?php echo __('add'); ?></button>
                </div>
            </form>
        </div>
    </div>
